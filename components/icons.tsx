...
export const PlaceholderIcon: React.FC = () => (
    <div className="w-10 h-10 bg-gray-600 rounded-md flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-400">
            <path d="M4.5 10.5c-2.2 2.2-2.2 5.8 0 8s5.8 2.2 8 0c1.4-1.4 2-3.3 2-5"/>
            <path d="M19.5 13.5c2.2-2.2 2.2-5.8 0-8s-5.8-2.2-8 0c-1.4 1.4-2 3.3-2 5"/>
...
export const WeightIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4 12h16"/>
        <path d="M4 12a4 4 0 0 1-4-4V6a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v2"/>
        <path d="M20 12a4 4 0 0 0 4-4V6a2 2 0 0 0-2-2h0a2 2 0 0 0-2 2v2"/>
